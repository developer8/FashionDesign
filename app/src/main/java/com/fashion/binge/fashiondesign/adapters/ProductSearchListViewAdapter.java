...
public class ProductSearchListViewAdapter extends BaseAdapter implements StickyListHeadersAdapter, SectionIndexer, Filterable {
    ...
    public ProductSearchListViewAdapter(Context context, List<ShoppageInfo> shopPageModels) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context)
                .load(allShopPage.getSellerAvater())
                .into(holder.avatar);
