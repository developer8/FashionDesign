...
public class EditProfileAccount {
    ...
    public EditProfileAccount(Context context) {
        this.context = context;
    }

    public void setEditprofile(final SweetAlertDialog sweetAlertDialog, final String email, final String firstname, final String lastname, final String telephone,final String headerValue, final ResponseInfoHolder responseInfoHolder) {
        StringRequest requestToken = new StringRequest(Request.Method.POST,  JSONUrl.BASE_URL+JSONUrl.EDIT_USER_PROFILE, new Response.Listener<String>() {
            @Override
