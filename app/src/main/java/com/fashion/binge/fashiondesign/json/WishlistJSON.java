...
/**
 * Created by gokarna on 03/05/16.
 */
public class WishlistJSON {
    private Context context;
    private static final String tag_json_obj = "tag_json_obj";

    public WishlistJSON(Context context) {
        this.context = context;
    }

    public void getWishlistData(final SweetAlertDialog sweetAlertDialog, final String headerValue, final JsonResponseHolder jsonResponseHolder) {
        StringRequest requestToken = new StringRequest(Request.Method.GET,  JSONUrl.BASE_URL+JSONUrl.GET_WISHLIST_URL, new Response.Listener<String>() {
            @Override
