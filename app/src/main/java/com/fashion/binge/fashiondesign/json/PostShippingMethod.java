...
public class PostShippingMethod {
    private Context context;
    private static final String tag_json_obj = "tag_json_obj";

    public PostShippingMethod(Context context) {
        this.context = context;
    }

    public void postShippingMethod(final SweetAlertDialog sweetAlertDialog, final String headerValue, final String shippingAddress,final JsonResponseHolder responseInfoHolder) {
        StringRequest requestToken = new StringRequest(Request.Method.POST,  JSONUrl.BASE_URL+JSONUrl.POST_SHIPPING_METHODS, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if(jsonObject.has("success")) {
                        ...
                        if (success.equals("true")) {
                            responseInfoHolder.onResponse(success,null);
                        } else {
                            responseInfoHolder.onResponse(success,"Error sending shipping method");
                        }
                    }else{
                        String statusCode = jsonObject.getString("statusCode");
                        String statusText = jsonObject.getString("statusText");
                        responseInfoHolder.onResponse(statusCode, statusText);
                    }
            ...
            public byte[] getBody() throws AuthFailureError {
                return shippingAddress.getBytes();
            }
