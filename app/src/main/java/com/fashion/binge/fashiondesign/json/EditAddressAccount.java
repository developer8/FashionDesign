...
public class EditAddressAccount {
    private Context context;
    private static final String tag_json_obj = "tag_json_obj";

    public EditAddressAccount(Context context) {
        this.context = context;
    }

    public void editAddressAccount(final SweetAlertDialog sweetAlertDialog, final String firstName, final String lastName, final String addressLineOne, final String addressLineTwo, final String city, String addressId, final String headerValue, final ResponseInfoHolder responseInfoHolder) {
        StringRequest requestToken = new StringRequest(Request.Method.PUT,  JSONUrl.BASE_URL+JSONUrl.EDIT_USER_ADDRESS + addressId, new Response.Listener<String>() {
            @Override
            ...
            public byte[] getBody() throws AuthFailureError {
                String taxId = "0";
                String str = "{\"address_1\":\"" + addressLineOne + "\"," +
