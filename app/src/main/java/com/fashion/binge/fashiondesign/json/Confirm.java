...
public class Confirm {
    ...
    public void postConfirm(final SweetAlertDialog sweetAlertDialog, final String headerValue, final ResponseInfoHolder responseInfoHolder) {
        StringRequest requestToken = new StringRequest(Request.Method.POST,  JSONUrl.BASE_URL+JSONUrl.CONFIRM_URL, new Response.Listener<String>() {
            @Override
